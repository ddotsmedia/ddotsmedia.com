...
export function TopBar() {
  return (
    <div className="sticky top-0 z-50 w-full border-b border-white/5 bg-[#0d1117] py-2">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:justify-center lg:gap-10 lg:px-8">
        <a
