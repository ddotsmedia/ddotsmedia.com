...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_projects_category" AS ENUM('Web', 'iOS', 'Android', 'Desktop', 'ERP');
  CREATE TYPE "public"."enum_projects_status" AS ENUM('Live', 'In Progress');
  CREATE TYPE "public"."enum_projects_preview_type" AS ENUM('liveEmbed', 'video', 'deviceMockup', 'screenshots');
  CREATE TYPE "public"."enum_projects_device_type" AS ENUM('iphone', 'android', 'macbook', 'browser');
  ...
  CREATE TABLE "projects" (
  	...
  	"preview_type" "enum_projects_preview_type",
  	"preview_video_url" varchar,
  	"device_type" "enum_projects_device_type",
  	"problem" jsonb,
  	"solution" jsonb,
  	"results" jsonb,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_projects_preview_type";
  DROP TYPE "public"."enum_projects_device_type";`)
}
